...
from Patricia.__main__ import STATS, USER_INFO, TOKEN
from Patricia.modules.sql import SESSION
from Patricia.modules.disable import DisableAbleCommandHandler
from Patricia.modules.helper_funcs.chat_status import user_admin, sudo_plus
...
def stats(update, context):
    ...
    kb = [
          [
           InlineKeyboardButton('Channel', url='t.me/patricia_Updates'),
           InlineKeyboardButton('Support', url='t.me/patricia_support')
          ]
    ]
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/TEAM-PATRICIA/PATRICIA-PROBOT) \n\n" +
            "╘══「 by [Blaze](t.me/piroXpower)」\n",
