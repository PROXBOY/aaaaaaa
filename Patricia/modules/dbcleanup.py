...
import Patricia.modules.sql.antispam_sql as gban_sql
import Patricia.modules.sql.users_sql as user_sql
from Patricia import DEV_USERS, OWNER_ID, dispatcher
