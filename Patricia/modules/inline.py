...
import Patricia.modules.sql.users_sql as sql
...
from Patricia.modules.helper_funcs.misc import article
from Patricia.modules.helper_funcs.decorators import kiginline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on Patricia",
            "description": "Look up a Telegram account in Patricia database",
            "message_text": "Click the button below to look up a person in Patricia database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/fdcf54623b142ac333217.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Patricia",
            "message_text": "Click the button below to get to know about Patricia.",
            "thumb_urL": "https://telegra.ph/file/fdcf54623b142ac333217.jpg",
            "keyboard": ".about ",
        },
        {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a Dev of Patricia"
        nation_level_present = True
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    kb = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton(
                    text="My Love",
                    url=f"https://t.me/piroXpower",
                ),
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/EagleCoderZ/Patriciarobot",
                ),
            ],
        ])
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Patricia (@{context.bot.username})",
