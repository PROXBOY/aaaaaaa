...
from Patricia.modules.helper_funcs.handlers import CMD_STARTERS
from Patricia.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Patricia.modules.sql import disable_sql as sql
