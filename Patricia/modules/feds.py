...
from Patricia.modules.helper_funcs.string_handling import markdown_parser

import Patricia.modules.sql.feds_sql as sql

from Patricia.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
...
def fed_help(update: Update, context: CallbackContext):
    ...
    query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton(text='Report Error', url='https://t.me/patricia_support')]]
        ),
    )
